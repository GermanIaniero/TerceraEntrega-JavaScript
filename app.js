const contenedorProductos = document.getElementById('conten-productos')
...
stockProductos.forEach((producto) => {
    ...
    <h3 style="text-transform:uppercase;">${producto.descrip}</h3>
...
const actualizarCarrito = () => {
    ...
    carrito.forEach((prod) => {
        ...
        div.innerHTML = `
        <p style="text-transform:uppercase;">${prod.descrip}</p>
